...
import StudentFirstLevelTable from "@/app/Components/StudentLevel1TableComponent";
const fetchStudents = async ({queryKey}) => {
    ...
    try{
        const response = await axios.get(`${API_URL_Natega}/first-year/natega`,{
            params:{
                StudentName,
                IDCode
            }
...
function ShowResult() {
    ...
    return ( 
        <div className="w-full flex justify-center">
            ...
            <Button href="http://localhost:3000/firstIT" as={Link} size="lg" className="flex justify-center max-w-32"> Back </Button></div> : "" }
            {data? <StudentFirstLevelTable data={data}></StudentFirstLevelTable>: ""}
